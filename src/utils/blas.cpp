...
#define DEF_GEMM(prefix, intype, outtype)                                                                                           \
    extern "C" void prefix##gemm_ex(const char transa, char transb, int m, int n, int k,                                            \
        outtype alpha, const intype *a, int lda, const intype *b, int ldb, outtype beta,                                            \
        outtype *c, int ldc, const BlasExtendParam *kutacc_param);                                                                  \
    extern "C" size_t prefix##gemm_pack_get_size(char identifier, int m, int n, int k);                                             \
    extern "C" void prefix##gemm_pack(char identifier, char transa, char transb, int M,                                             \
        int N, int K, int lda, int ldb, const intype *src, intype *dst);                                                            \
    template <>                                                                                                                     \
